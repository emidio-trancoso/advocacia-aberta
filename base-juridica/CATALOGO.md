...
número único produziria registros ambíguos. O Decreto 2.044/1908 (letra de
câmbio) também está em `pendentes_especiais`: a URL da planilha corresponde ao
Decreto 2.044/1996 (isenção de vistos) — divergência flagrada pela conferência
de cabeçalho do revisor — e a página oficial do decreto de 1908 não foi
localizada no ccivil_03. Observações das
