...
|---|---:|---:|---|
| Legislação | 222 | 18.608 registros | 222 diplomas |
...
| Total em JSON | 229 | — | 36.503.662 bytes, cerca de 37 MB |
...
Todos os 18.608 registros legislativos possuem URL individual. Os metadados apontam
...
Grupos pendentes de materialização: decretos (1) e as duas fatias de esparsas
por macro-área restantes (48 normas). O Código Comercial de 1850 foi movido
...
|---|---|
| Arquivos disponíveis | 133 diplomas: núcleo (11), piloto (8), estatutos (17), trabalhista (27), codificadas (7), penal (17), tributário (16), previdenciário (12), cível/família (18), eleitoral (13), imobiliário/agrário (10), administrativo (23), processual/constitucional (19) e consumidor/bancário (24); a lista completa está no registro do motor e no manifesto da expansão |
| Códigos declarados no TypeScript | exatamente os 222 arquivos disponíveis (expansão gerada entre marcadores) |
| Busca com código específico | aceita os 222 códigos; valor desconhecido produz erro legível |
| Busca `todos` | os 222 códigos do registro central |
...
- a avaliação de recuperação cobre 69 consultas controladas e seis famílias; ela é um
